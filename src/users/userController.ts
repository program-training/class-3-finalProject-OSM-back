...
import { registerService, loginService, forgotPasswordService, resetPasswordService, deleteUserByIdService, getAllUsersService, comperepasswordService } from "./userService";
...
export const registerController = async (req: Request, res: Response) => {
  try {
    ...
    if (registerUser.password) registerUser.password = generateUserPassword(registerUser.password);
